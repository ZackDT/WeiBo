...
public extension UIImage {
    ...
    - Parameter gradientColors: 颜色值
    - Parameter size: 图片大小 (defaults: 10x10)
    ...
    */
    ...
    - Parameter text: 文本内容
    - Parameter font: 字体代销 默认18
    - Parameter color: 字体颜色，默认白色
    - Parameter backgroundColor: 背景颜色 (default:Gray).
    ...
    */
    ...
    /**
     返回一个副本给图像,添加一个alpha通道如果不已经有一个了
     */
