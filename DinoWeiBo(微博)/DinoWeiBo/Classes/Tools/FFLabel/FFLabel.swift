...
public class FFLabel: UILabel {
    ...
    // MARK: - upadte text storage and redraw text 更新文本容器，绘制文本
    ...
    /// use regex check all link ranges 过滤URL
    ...
    // TextKit框架
    private lazy var textStorage = NSTextStorage()  //文本存储  NSMutableAttributedString子类
    private lazy var layoutManager = NSLayoutManager()  // 管理布局。-负责文本绘制。图文混排绘制
    private lazy var textContainer = NSTextContainer()  //文本容器 - 设置绘制尺寸
